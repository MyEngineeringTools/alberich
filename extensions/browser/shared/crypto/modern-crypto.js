 ...
 * @returns {string}
 */
export function resolveEndwalzeWiring(reflectorId, reflectorDPairs = DEFAULT_REFLECTOR_D_PAIRS) {
  ...
  if (id === REFLECTOR_ID_DORA) {
    const ukw = buildDoraReflectorWiring(reflectorDPairs || DEFAULT_REFLECTOR_D_PAIRS);
