...
für die Dauer eines Zeitslots (24 h / 4 h / 1 h je nach Tafel).
Historische Multi-Message-Angriffe bleiben das relevante Modell.
**Assumptions:** Mehrere ALBV-Telegramme unter demselben vollen V3-Schlüssel.
**Mitigation:** Tafel bzw. Timebook. Kürzere Intervalle begrenzen die
Nachrichtenmenge unter demselben vollständigen Schlüssel. Das ist kein
Forward Secrecy und keine Post-Compromise Security.

## V3 gehärtet (Web, Release Candidate)

Zusätzlich zum bisherigen Modern-V3-Pfad:

- CSPRNG-Keygen je Slot, lokale Spruchschlüssel-Wiedervermeidung
- unabhängige zeitlich wechselnde vollständige V3-Schlüssel
- Rollback-Schutz für neue Sendesessions
- CBQR2 + MUR für die Tafelverteilung

Nicht behauptet: globale MK-Eindeutigkeit, mathematisch bewiesene
Sicherheit, Weak-Cycle-Rejection (P0.4 bleibt Laboratory).
