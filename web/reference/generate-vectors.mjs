#!/usr/bin/env node
/**
 * Historical generator for reference/golden-vectors.json.
 * Does NOT write reference/v3-protocol-golden.json.
 * V3_PROTOCOL_GOLDEN is frozen (W1). Do not regenerate it because a new
 * implementation disagrees — that would be a protocol/core change.
 */
import { writeFileSync } from 'node:fs';
import { CipherEngine } from '../js/cipher-engine.js';
import { modernV3EncryptPayload, utf8ToBase26v2 } from '../js/modern-v3.js';
